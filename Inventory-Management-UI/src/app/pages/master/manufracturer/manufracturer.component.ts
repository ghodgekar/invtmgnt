  ...
  onSubmit(): void {
    ...
    if (this.manufracturerForm.invalid) {
      ...
      if(this.submitBtn == 'SAVE'){
        ...
        this.common.save( this.manufracturerForm.value, this.view).subscribe((res:any) => {
        ...
        this.common.update(this.manufracturerForm.value, this.view).subscribe((res:any) => {
          $('#evaluator_table').DataTable().ajax.reload();
          this.isEdit = false;
          this.submitBtn = 'SAVE';
          this.onReset();
