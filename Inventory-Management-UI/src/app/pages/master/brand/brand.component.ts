  ...
  onSubmit(): void {
    ...
    if (this.brandForm.invalid) {
      ...
      if (this.submitBtn == 'SAVE') {
        ...
        this.common.save(this.brandForm.value, this.view).subscribe((res: any) => {
        ...
        this.common.update(this.brandForm.value, this.view).subscribe((res: any) => {
          $('#evaluator_table').DataTable().ajax.reload();
          this.isEdit = false;
          this.submitBtn = 'SAVE';
          this.onReset();
